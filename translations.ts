...
export const translations = {
  sw: {
    ...
    coins: 'Coins',
    coinsUpper: 'COINS',
    officialStream: 'Stream Rasmi ya Adam AD',
    heroTitle1: 'PIRA',
    heroTitle2: 'LIVE',
    heroDesc: 'Ungana na wadau wa soka Tanzania. Tazama mechi, cheza michezo ya ushindi na upate msaada wa Adam AI.',
  ...
  en: {
    ...
    coins: 'Coins',
    coinsUpper: 'COINS',
    officialStream: 'Official Adam AD Stream',
    heroTitle1: 'MATCH',
    heroTitle2: 'LIVE',
    heroDesc: 'Connect with football fans in Tanzania. Watch matches, play winning games, and get Adam AI support.',
